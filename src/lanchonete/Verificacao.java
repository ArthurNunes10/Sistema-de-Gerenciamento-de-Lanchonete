...
public class Verificacao {
	...
	public int procurarFuncionario(ArrayList<Funcionario> lista, String nome) {
		int indice = -1;
	...
	public int procurarCliente(ArrayList<Cliente> lista, String cpf) {
		int indice = -1;
	...
	public int procurarComida(ArrayList<Comida> lista, String nome) {
		int indice = -1;
	...
	public int procurarBebida(ArrayList<Bebida> lista, String nome) {
		int indice = -1;
	...
	public int procurarPedido(ArrayList<Pedido> lista, String nome) {
		int indice = -1;
